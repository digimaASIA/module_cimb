...
UlarTangga.prototype.init = function(current_settings) {
    ...
    $.get("config/setting_quiz_slide_"+$this.current_settings["slide"]+".json",function(e){
        ...
        // $.get("config/setting_ular_tangga.json",function(e2){
          // console.log(e2);

          $this.start_step = e2["list_steps"]["start_step"];
          $this.finish_step = e2["list_steps"]["finish_step"];
          $this.step_data = e2["list_steps"]["list_step"];
...
UlarTangga.prototype.show_life = function() {
...
UlarTangga.prototype.setProgresBar = function() {
  var $this = this;
  console.log($this.curr_step);
  console.log($this.total_step);
...
UlarTangga.prototype.showModal = function() {
...
UlarTangga.prototype.showStep = function(){
  var $this = this;
...
UlarTangga.prototype.sliderPopup = function($elementModal) {
  var $this = this;
